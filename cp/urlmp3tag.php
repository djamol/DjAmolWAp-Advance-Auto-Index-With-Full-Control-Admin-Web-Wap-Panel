...
$default_comment = "Mp3 by DjAmol Group";
$default_artist = "Wap.DjAmol.Com";
$default_album = "(DjAmol.Com)";
$default_year = date("Y");
$default_genre = "Wap.DjAmol.Com";
    ...
    if(filter_var($mp3_filepath,FILTER_VALIDATE_URL)){
        if($mp3_filename!=""){
            ...
            if(copy($mp3_filepath,$sname)){
                ...
                require_once('../moduls/id3/getid3/getid3.php');
                $mp3_handler = new getID3;
                $mp3_handler->setOption(array('encoding'=>$mp3_tagformat));
                require_once('../moduls/id3/getid3/write.php');
...
<br />&raquo; Year
<br /><input size="50" type="text" class="input" name="mp3_year" value="<?php echo $default_year ; ?>" /><!--DjAmolWap12v Powered By DjAmolGroup Inc. (WwW.DjAmol.Com) -->
<br />&raquo; Genre
...
<br /><!--DjAmolWap12v Powered By DjAmolGroup Inc. (WwW.DjAmol.Com) -->
