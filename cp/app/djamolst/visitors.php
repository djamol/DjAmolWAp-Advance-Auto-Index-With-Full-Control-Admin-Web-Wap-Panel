...
<title>DjAmolS- Site Stats</title>
<link href="djamolst.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div id="container">
<div id="logo"><h1>DjAmolGroup Stats</h1></div>
<div id="menu">
 <ul>
...
?>
  ...
  <div style="clear:both"></div>
  <div id="footer">DjAmolGroup Inc. <a href="http://ai.djamol.com" target="_blank" >Amol_Patil</a></div>
</div>
</body>
</html>