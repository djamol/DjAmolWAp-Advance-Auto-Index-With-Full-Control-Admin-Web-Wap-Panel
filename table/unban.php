...
$q=mysql_query("DELETE FROM `bans` WHERE `id`='".(int)$_GET["id"]."' LIMIT 1;"); if($q) { echo 'User successfully unban!<br><a href="guest.php">Further</a><br>';} else { echo '<font color="red">Request Failed!</font><br>'; } 
?>